    ...
    calcular(){
       ...
       //2) Calculos os preços
        ...
        //6.1) Exibir preços na tela
         document.getElementById("precoCelofane").innerText= precoCelofane.toFixed(2);
         document.getElementById("precoCrepom").innerText= precoCrepom.toFixed(2);
         document.getElementById("precoLacoChanel").innerText= precoLacoChanel.toFixed(2);
         document.getElementById("precoImportado").innerText= precoImportado.toFixed(2);
         document.getElementById("precoCaixa").innerText= precoCaixa.toFixed(2);
  
        //6.2) Exibir Bonus
        document.getElementById("bonusCelofane").innerText= bonusCelofane.toFixed(2);
        document.getElementById("bonusCrepom").innerText= bonusCrepom.toFixed(2);
        document.getElementById("bonusLacoChanel").innerText= bonusLacoChanel.toFixed(2);
        document.getElementById("bonusImportado").innerText= bonusImportado.toFixed(2);
        document.getElementById("bonusCaixa").innerText= bonusCaixa.toFixed(2);
